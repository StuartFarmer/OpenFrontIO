...
## Exit Criteria
- [x] Adapter constructs and disposes the custom WebGL view.
- [x] Clicks map to tile refs without OpenFront `InputHandler`.
- [x] Placement updates tile ownership rendering.
- [x] Renderer compatibility types stay inside adapter/client code.
