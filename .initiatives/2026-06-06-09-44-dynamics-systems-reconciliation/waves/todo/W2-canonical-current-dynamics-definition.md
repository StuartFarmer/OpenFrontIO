...
- [ ] Schema tests prove definitions, scenarios, view metadata, and runtime state are separate.
- [ ] Existing saved/imported v1 systems still load.
- [ ] Editor save/load/import/export behavior remains intact.
