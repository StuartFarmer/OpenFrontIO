...
## Exit Criteria
- [ ] Metric bars, pills, segmented controls, blend sliders, and mini meters no longer require copied Tailwind structure.
- [ ] `/hud-kit` demonstrates each core molecule from the shared exports.
