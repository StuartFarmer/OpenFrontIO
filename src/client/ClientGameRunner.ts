...
import { OpenFrontClientModule } from "../games/openfront/client/OpenFrontClientModule";
...
import { GameRenderer } from "./hud/GameRenderer";
...
export function joinLobby(
  ...
  const onmessage = (message: ServerMessage) => {
    ...
    if (message.type === "start") {
      ...
      OpenFrontClientModule.mount({
        clientID,
        eventBus,
        lobbyConfig,
        mapLoader: terrainMapFileLoader,
        terrainLoad,
        transport,
        userSettings,
      })
