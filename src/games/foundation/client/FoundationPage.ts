...
> = {
  ...
  baseFoodStorageCapacity: {
    does: "Adds flat storage capacity before starter silos are counted.",
    exists:
      "Keeps a backward-compatible flat capacity term alongside silo capacity.",
    represents: "Extra built-in stockpile room.",
    increase: "Allows more reserve food to be saved.",
    decrease: "Makes the silo count matter more.",
    formula:
      "foodStockCapacity = baseFoodStorageCapacity + baseSilosOwned * addedStorageCapacityPerSilo",
  },
  baseSilosOwned: {
    does: "Sets the starter silo count used by stockpile capacity.",
    exists: "Gives the player storage before actual storage buildings exist.",
    represents: "Initial storage infrastructure.",
    increase: "Raises the food stockpile cap.",
    decrease: "Lowers the food stockpile cap.",
    formula:
      "foodStockCapacity = baseFoodStorageCapacity + baseSilosOwned * addedStorageCapacityPerSilo",
  },
  addedStorageCapacityPerSilo: {
    does: "Sets how much stockpile capacity each silo contributes.",
    exists: "Turns storage buildings into a capacity multiplier.",
    represents: "Per-silo warehouse size.",
    increase: "Makes each silo support a larger stockpile.",
    decrease: "Makes storage expansion more constrained.",
    formula:
      "foodStockCapacity = baseFoodStorageCapacity + baseSilosOwned * addedStorageCapacityPerSilo",
  },
  stockpileGrowthRate: {
    does: "Controls how quickly reserve food fills the stockpile.",
    exists:
      "Lets storage approach capacity smoothly instead of jumping instantly.",
    represents: "Collection, logistics, spoilage, and storage friction.",
    increase: "Fills the stockpile faster.",
    decrease: "Makes reserves accumulate more slowly.",
    formula:
      "foodStockNext = max(foodStock + foodForStorage * stockpileGrowthRate * (1 - foodStock / foodStockCapacity), 1)",
  },
  placementRadius: {
  ...
  foodPerTile: {
    ...
    represents: "Average food output per controlled tile.",
    increase: "Raises both population support and stockpile reserve flow.",
    decrease: "Lowers population capacity and reserve accumulation.",
    formula: "foodProduction = tilesOwned * foodPerTile",
  },
  foodReservePercentage: {
    does: "Splits produced food between storage and people.",
    exists:
      "Lets the player reserve part of production instead of feeding all of it into population capacity.",
    represents: "The share of food production routed into stockpile supply.",
    increase: "Fills storage faster but lowers population capacity.",
    decrease: "Supports more population but stores less food.",
    formula:
      "foodForStorage = foodProduction * foodReservePercentage; foodForPeople = foodProduction - foodForStorage",
  },
  maxPopulationGrowthRate: {
    does: "Sets the maximum per-tick population growth rate.",
    exists:
      "Controls how quickly population approaches food-supported capacity.",
    represents: "Population growth momentum.",
    increase: "Makes population react faster to new food capacity.",
    decrease: "Makes population growth slower and smoother.",
    formula:
      "populationNext = max(population + maxPopulationGrowthRate * population * (1 - population / populationCapacity), 1)",
  },
  foodYieldMin: {
